...
namespace ByteDance {
    ...
    /// unevaluatedItems/unevaluatedProperties, $vocabulary, and remote $ref.
    ...
    public:
        ...
        //== Construction ====================================================
        /// Compiles aSchema (deep-copied) with the supplied options.
        ...
        /// Validates and appends discovered failures to aErrors. Never throws.
